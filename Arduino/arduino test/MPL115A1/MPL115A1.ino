/*
MPL115A1 5Hz-electronica
Ejemplo que muestra el funcionamiento del MPL115A1 en modo SPI
 SDN       : pin 7
 CSN       : pin 10
 SDI/MOSI  : pin 11
 SDO/MISO  : pin 12
...
Serial.println("");
  ...
  do{
      ...
      if (opcion == 1) 
    Serial.println("Hola soy la TERMINAL DE 5Hz (presione el * para ir al menu) cuando termines ");
    delay(1000);
}
